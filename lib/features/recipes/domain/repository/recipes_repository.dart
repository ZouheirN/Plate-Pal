...
abstract class RecipesRepository {
  ...
  Future<DataState<List<RecipeInstructionsEntity>>> getRecipeInstructions({required int recipeId});

  // Gets similar recipes
  Future<DataState<List<SimilarRecipesEntity>>> getSimilarRecipes({required int recipeId});

  // Get recipe information
  Future<DataState<RecipeEntity>> getRecipeInformation({required int recipeId});
}
